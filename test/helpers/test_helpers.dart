...
MockCastService getAndRegisterCastService() {
  _removeRegistrationIfExists<CastService>();
  final service = MockCastService();
  locator.registerSingleton<CastService>(service);
  return service;
}

MockReviewService getAndRegisterReviewService() {
