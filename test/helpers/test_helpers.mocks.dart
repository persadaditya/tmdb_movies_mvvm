...
class _FakeMovieImage_6 extends _i1.SmartFake implements _i6.MovieImage {
  _FakeMovieImage_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockAuthService extends _i1.Mock implements _i15.AuthService {
  ...
  @override
  _i8.Future<String?> createRequestToken() => (super.noSuchMethod(
        Invocation.method(
          #createRequestToken,
          [],
        ),
  ...
  @override
  _i8.Future<String> validateLogin(
    String? username,
    String? password,
    String? requestToken,
  ) =>
  ...
  @override
  _i8.Future<String> createSession(String? requestToken) => (super.noSuchMethod(
        Invocation.method(
          #createSession,
          [requestToken],
        ),
  ...
  @override
  _i8.Future<_i17.GuestSessionResponse?> createGuestSession() =>
      (super.noSuchMethod(
        Invocation.method(
          #createGuestSession,
          [],
        ),
        returnValue: _i8.Future<_i17.GuestSessionResponse?>.value(),
        returnValueForMissingStub:
            _i8.Future<_i17.GuestSessionResponse?>.value(),
      ) as _i8.Future<_i17.GuestSessionResponse?>);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLocalDataService extends _i1.Mock implements _i18.LocalDataService {
  @override
  _i8.Future<String?> getSession() => (super.noSuchMethod(
        Invocation.method(
          #getSession,
          [],
        ),
  ...
  @override
  _i8.Future<void> setSession(String? session) => (super.noSuchMethod(
        Invocation.method(
          #setSession,
          [session],
        ),
  ...
  @override
  _i8.Future<String?> getGuestSession() => (super.noSuchMethod(
        Invocation.method(
          #getGuestSession,
          [],
        ),
  ...
  @override
  _i8.Future<void> setSessionGuest(String? guestSession) => (super.noSuchMethod(
        Invocation.method(
          #setSessionGuest,
          [guestSession],
        ),
  ...
  @override
  _i8.Future<void> removeSession() => (super.noSuchMethod(
        Invocation.method(
          #removeSession,
          [],
        ),
  ...
  @override
  _i8.Future<void> removeGuestSession() => (super.noSuchMethod(
        Invocation.method(
          #removeGuestSession,
          [],
        ),
  ...
  @override
  _i8.Future<void> setUser(_i19.User? user) => (super.noSuchMethod(
        Invocation.method(
          #setUser,
          [user],
        ),
  ...
  @override
  _i8.Future<void> removeUser() => (super.noSuchMethod(
        Invocation.method(
          #removeUser,
          [],
        ),
  ...
  @override
  _i8.Future<void> setGenreMovies(List<_i20.Genre>? genres) =>
      (super.noSuchMethod(
        Invocation.method(
          #setGenreMovies,
          [genres],
  ...
  @override
  _i8.Future<List<_i20.Genre>?> getGenreMovies() => (super.noSuchMethod(
        Invocation.method(
          #getGenreMovies,
          [],
        ),
        returnValue: _i8.Future<List<_i20.Genre>?>.value(),
        returnValueForMissingStub: _i8.Future<List<_i20.Genre>?>.value(),
      ) as _i8.Future<List<_i20.Genre>?>);

  @override
  _i8.Future<String?> getGenreFromIds(List<int>? ids) => (super.noSuchMethod(
        Invocation.method(
          #getGenreFromIds,
          [ids],
        ),
...
class MockMovieService extends _i1.Mock implements _i22.MovieService {
  ...
  @override
  _i8.Future<_i4.Paginated<_i5.Movie>> loadPopularMovies({int? page = 1}) =>
      (super.noSuchMethod(
        Invocation.method(
          #loadPopularMovies,
          [],
  ...
  @override
  _i8.Future<_i4.Paginated<_i5.Movie>> loadTopRatedMovies({int? page = 1}) =>
      (super.noSuchMethod(
        Invocation.method(
          #loadTopRatedMovies,
          [],
  ...
  @override
  _i8.Future<_i4.Paginated<_i5.Movie>> loadNowPlayingMovies({int? page = 1}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i8.Future<_i5.Movie> loadMovie(int? id) => (super.noSuchMethod(
        Invocation.method(
          #loadMovie,
          [id],
        ),
  ...
  @override
  _i8.Future<_i4.Paginated<_i5.Movie>> loadSimilarMovies(
    int? id, {
    int? page = 1,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<List<_i20.Genre>> loadGenres() => (super.noSuchMethod(
        Invocation.method(
          #loadGenres,
          [],
        ),
        returnValue: _i8.Future<List<_i20.Genre>>.value(<_i20.Genre>[]),
        returnValueForMissingStub:
            _i8.Future<List<_i20.Genre>>.value(<_i20.Genre>[]),
      ) as _i8.Future<List<_i20.Genre>>);

  @override
  _i8.Future<_i6.MovieImage> loadMovieImages(int? id) => (super.noSuchMethod(
        Invocation.method(
          #loadMovieImages,
          [id],
        ),
        returnValue: _i8.Future<_i6.MovieImage>.value(_FakeMovieImage_6(
          this,
          Invocation.method(
            #loadMovieImages,
            [id],
        ...
        returnValueForMissingStub:
            _i8.Future<_i6.MovieImage>.value(_FakeMovieImage_6(
          this,
          Invocation.method(
            #loadMovieImages,
            [id],
